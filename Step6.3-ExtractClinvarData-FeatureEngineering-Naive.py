...
class RowIndependentFeatureEngineer:
    def __init__(self, dataset_dir: str = "Clinvar_Dataset", config_path: Optional[str] = None):
        """
    ...
    def setup_curated_features(self) -> None:
        ...
        self.other_prediction_features = [
            ...
            'MPC_score', 'MPC_rankscore', 'MPC_score_dbnsfp42c', 'MPC_rankscore_dbnsfp42c', 'Aloft_pred', 'Aloft_Confidence', 'Aloft_pred_dbnsfp42c', 'Aloft_Confidence_dbnsfp42c'
        ]
    ...
    def get_default_feature_config(self) -> Dict:
        ...
        return {
            ...
            "use_computational_predictions": False,
            "use_conservation_scores": True,
            "use_functional_annotations": True,
            "use_population_frequencies": False,
            "use_other_predictions": False,
            "use_categorical_features": True,
            "use_biological_raw": False,
            
            # NEW: Unified prediction mapping
            "use_unified_mapping": False,
            
            # Row-independent engineered features
            "amino_acid_features": {
                "enabled": False,
                "blosum62_score": False,
                "blosum62_categories": False,
                "aa_property_changes": False,
                "aa_chemical_classes": False,
                "aa_size_changes": False,
                "aa_structural_impact": False,
                "aa_polarity_change": False,
                "aa_charge_change": False
            },
            
            "codon_features": {
                "enabled": False,
                "codon_gc_content": False,
                "codon_cpg_content": False,
                "codon_degeneracy": False,
                "wobble_position": False,
                "codon_optimality": False,
                "start_stop_codons": False,
                "codon_bias_score": False,
                "codon_position_impact": False
            },
            
            "nucleotide_features": {
                "enabled": False,
                "transition_transversion": False,
                "purine_pyrimidine": False,
                "gc_content_change": False,
                "cpg_context": False,
                "base_composition": False,
                "nucleotide_complexity": False,
                "dinucleotide_change": False
            },
            ...
            "interaction_features": {
                ...
                "conservation_prediction_products": False,
                "pairwise_interactions": False,
                "score_differences": False,
...
def main():
    ...
    parser.add_argument('dataset_dir', nargs='?', default='Clinvar_Dataset3',
