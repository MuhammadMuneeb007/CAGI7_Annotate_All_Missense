...
class RowIndependentFeatureEngineer:
    def __init__(self, dataset_dir: str = "Clinvar_Dataset8", config_path: Optional[str] = None):
        """
    ...
    def setup_curated_features(self) -> None:
        ...
        self.other_prediction_features = [
            ...
            'DANN_score', 'DANN_rankscore','am_class', 'DANN_score_dbnsfp42c', 'DANN_rankscore_dbnsfp42c',
    ...
    def get_default_feature_config(self) -> Dict:
        ...
        return {
            ...
            "use_functional_annotations": False,
...
def main():
    ...
    parser.add_argument('dataset_dir', nargs='?', default='Clinvar_Dataset8',
